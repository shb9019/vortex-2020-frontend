...
export default class Sponsor extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            sponsorImgs: ['souled-store.png', 'zoomin.svg', 'infoview.png', 'practisc.svg', 'tcf.svg', 'delta.png', 'uniq.jpeg'],
            sponsorDescriptions: ['Official Gifting Partner', 'Associate Partner', 'Title Sponsor', 'Memento Sponsor', 'Official Ticketing Partner', 'Web Hosting Partner', 'Merchandise Sponsor'],
            sponsorLinks: ['https://www.thesouledstore.com/', 'https://www.zoomin.com/', 'https://www.ivtlinfoview.com/', 'https://www.practisclabs.com', 'https://www.thecollegefever.com/', 'https://delta.nitt.edu', 'https://www.uniqtechnologies.co.in/']
        };
